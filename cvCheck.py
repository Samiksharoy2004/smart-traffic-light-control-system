...
cap = cv2.VideoCapture("C:/Users/Tony/Desktop/A-Z/Mini Project/ITSS/Tony2.mp4")
...
while cap.isOpened():
    ...
    resized_frame = cv2.resize(annotated_frame, (720, 1020))

    cv2.namedWindow("Video Detection", cv2.WINDOW_NORMAL)  # Makes window resizable
    cv2.resizeWindow("Video Detection", 720, 1280)  # Initial size
